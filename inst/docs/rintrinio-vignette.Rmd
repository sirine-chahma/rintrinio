...
fs_ts <- gather_financial_statement_time_series(api_key = api_key, 
                                                ticker = 'AAPL',
...
fs_compare <- gather_financial_statement_company_compare(api_key = api_key, 
                                                         ticker = c("AAPL", "CSCO"), 
                                                         statement = "income_statement", 
                                                         year = "2019", 
                                                         period = "Q1")

knitr::kable(fs_compare)
```
