...
Note that the API key must be of type `charactere` when it is used in our functions. Hence, don't forget to use quotation marks when you use your API key.
...
As a start, here are a few tickers that you can use : 'AAPL', 'AXP', 'BA', 'CAT', 'CSCO', 'CVX', 'DIS', 'DWDP', 'GE', 'GS', 'HD', 'IBM', 'INTC', 'JNJ', 'JPM', 'KO', 'MCD', 'MMM', 'MRK', 'MSFT', 'NKE', 'PFE', 'PG', 'TRV', 'UNH', 'UTX', 'V', 'VZ', 'WMT', 'XOM'.

Here are some examples of statements : 'income_statement', 'balance_sheet_statement', 'cash_flow_statement'.
